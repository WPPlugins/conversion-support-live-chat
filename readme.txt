...
Learn more http://www.conversionsupport.com/features/features.html
...
1.Login to your website’s WordPress administration area and go to Plugins >> Add new.

2.On the search results page, click “Install now”.

3.When the plugin is installed, click “Activate plugin”.

4.Once the plugin has been activated, go to Settings > Conversion Support.

5.On the plugin options page, click on “Sign into Conversion Support”. 


== Changelog ==

1.0.6  This is the first iteration of the plugin.
1.0.7 screenshots added
== Upgrade Notice ==
